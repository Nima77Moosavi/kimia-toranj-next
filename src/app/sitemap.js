...
export default async function sitemap() {
  ...
  const staticRoutes = [
    ...
    "category/brass-products/nut-bowl",
    "/category/brass-products/pistachio-bowl",
    "/category/brass-products/pitcher",
    "/category/brass-products/tea-glass-holder",
    "/category/silver-plated",
    "/category/silver-plated/chocolate-bowl",
    "/category/silver-plated/fruit-bowl",
    "/category/silver-plated/kashkul",
    "/category/silver-plated/nut-bowl",
    "/category/silver-plated/others",
    "/category/silver-plated/plate",
    "/category/silver-plated/samovar",
    "/category/silver-plated/swan",
    ...
    "/post/A-complete-guide-to-buying-luxury-brass-products-as-gifts-from-Isfahan-handicrafts",
    "/post/Differences-Between-Original-Brass-And-Fake-Brass",
    "/post/Brass-Products-Care-And-Cleaning-Guide",
  ].map((path) => ({
    url: `${baseUrl}${path}`,
    lastModified: new Date(),
    changeFrequency: "daily",
