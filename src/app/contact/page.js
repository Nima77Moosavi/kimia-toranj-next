...
const shops = [
  {
    ...
    description:
      "شعبه اصفهان در قلب بازار تاریخی مسگرها قرار دارد؛ جایی که هنرمندان برجسته اصفهان مشغول ساخت میناکاری، خاتم‌کاری، قلم‌زنی و آثار اصیل ایرانی هستند. در این شعبه می‌توانید از نزدیک با دنیای زیبای صنایع‌دستی اصفهان آشنا شوید و آثار اورجینال با کیفیت بالا تهیه کنید.",
    mapEmbed:
...

  {
    id: 2,
    name: "کیمیا ترنج – اصفهان",
    address: "منطقه بازار بزرگ تهران، خیابان پانزده خرداد",
    phone: "۰۲۱-۹۸۷۶۵۴۳۲",
    image: "/images/store_2.webp",
    description:
      "شعبه اصفهان مجموعه‌ای از بهترین صنایع‌دستی اصفهان را ارائه می‌دهد؛ آثاری انتخاب‌شده از کارگاه‌های معتبر، مناسب برای هدیه، دکوراسیون و کلکسیونرها. در این شعبه می‌توانید با کیفیتی ممتاز و قیمت مناسب، هنر اصیل ایرانی را تهیه کنید.",
    mapEmbed:
  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        {/* توضیح صنایع‌دستی اصفهان */}
        <p className={styles.description}>
          اصفهان پایتخت هنر و صنایع‌دستی ایران است؛ شهری که قرن‌هاست
          هنرمندانش با عشق و مهارت آثاری چون{" "}
          <strong>مینا‌کاری</strong>، <strong>خاتم‌کاری</strong>،
          <strong>قلم‌زنی</strong> و <strong>فیروزه‌کوبی</strong> را خلق
          می‌کنند. آثار تولید شده در این شهر، ترکیبی از هنر، تاریخ و اصالت
          ایرانی هستند. شما می‌توانید نمونه‌های اصیل و با کیفیت این هنرها را
          در فروشگاه‌های ما از نزدیک مشاهده و تهیه کنید.
        </p>
