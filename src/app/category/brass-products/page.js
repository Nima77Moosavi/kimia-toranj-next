...
import BrassSamovarClient from "./BrassSamovarClient";

import styles from "./BrassSamovar.module.css";

export default async function BrassProductsPage() {
  const collectionRes = await fetch(`${API_URL}api/store/collections/3`, {
    next: { revalidate: 300 },
  });
      ...
      <div className={styles.pageContent}>
        <section className={styles.heroSection}>
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroSubtitle}>
              سماور برنجی یکی از نمادهای اصیل فرهنگ چای نوشی در ایران است؛
              محصولی که تلفیقی از کاربرد روزمره و هنر دست ساز ایرانی است.
            </p>
          </div>
          <div className={styles.heroImage}>
            <img
              src={collection.image }
              alt={collection.title || "سماور برنجی"}
          ...
          <div className={styles.container}>
            <div className={styles.introContent}>
              ...
              <p>
                ...
                تزئینی و کاربردی را مشاهده و خریداری کنید؛ محصولاتی که با دقت
                بالا ساخته شده اند و بعضا هنرهای دستی دیگری مثل قلمزنی یا
          ...
          <div className={styles.container}>
            ...
            <div className={styles.productTypesGrid}>
              <div className={styles.productTypeCard}>
                ...
                <p>
                  انتخابی کلاسیک برای علاقه مندان به روش های سنتی دم آوری چای.
              ...
              <div className={styles.productTypeCard}>
                ...
                <p>
                  ترکیبی از زیبایی سنتی و تکنولوژی مدرن. مناسب برای استفاده راحت
                  و روزمره در آشپزخانه‌های امروزی.
                </p>
              </div>
        ...
        <section className={styles.featuresSection}>
          <div className={styles.container}>
            ...
            <p className={styles.sectionSubtitle}>
              انتخاب سماور برنجی صرفا یک خرید نیست، بلکه یک سرمایه گذاری در
              زیبایی و ماندگاری است.
            </p>
            ...
            <div className={styles.featuresGrid}>
              ...
              <div className={styles.featureItem}>
                ...
                <p>
                  برنج گرما را به خوبی منتقل می کند، بنابراین سماور در مصرف
              ...
              <div className={styles.featureItem}>
                ...
                <p>
                  برخی مدل ها کاملاً عملیاتی هستند، درحالی که مدل‌های خاص تر
                  برای دکوراسیون داخلی طراحی شده اند.
                </p>
              </div>
        ...
        <section className={styles.decorationSection}>
          <div className={styles.container}>
            ...
            <div className={styles.decorationContent}>
              <p>
                اگر دکور خانه‌ات رو به سبک سنتی یا تلفیقی می‌چینی، یک سماور
                برنجی دقیقاً همون قطعه‌ایه که فضا رو تکمیل می‌کنه. این محصولات
                با فرم براق، جزئیات زیبا، و درخشندگی طلایی رنگ شون نه تنها حس
                گرما و صمیمیت می‌دن، بلکه نشون دهنده احترام به هنر و میراث
                فرهنگی ایران هم هستن.
              </p>
              <p>
                چه در اتاق پذیرایی باشه، چه روی اپن آشپزخونه یا در ویترین
                شیشه‌ای، سماور برنجی همیشه جلب توجه می‌کنه و به‌نوعی "امضای سبک
                زندگی ایرانی" محسوب می‌شه.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.buyingGuideSection}>
          <div className={styles.container}>
            ...
            <p className={styles.sectionSubtitle}>
              ما در فروشگاه کیمیا ترنج تلاش می کنیم تا خریدی راحت، مطمئن و
              آگاهانه برای شما فراهم کنیم.
            </p>
            ...
            <div className={styles.buyingGuideGrid}>
              ...
              <div className={styles.guideItem}>
                ...
                <p>
                  تمام محصولات با ضمانت اصالت و ارسال سریع از اصفهان ارائه
                  می‌شن.
                </p>
              </div>
            </div>
          ...
          <div className={styles.container}>
            ...
            <div className={styles.faqList}>
              ...
              <div className={styles.faqItem}>
                ...
                <p>
                  بله. به خصوص مدل های برقی و ساده تر، کاملاً برای استفاده
                  روزانه طراحی شدن. فقط به نگهداری درست نیاز دارن.
                </p>
              </div>
